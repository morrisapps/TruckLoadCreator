...
function heightLines(){
    ...
    while (i <= 11){
        ...
        topLines[i]= new fabric.Line([(i*96) + (75-2), 75, (i*96) + (75-2), 395], { id: 'top'+((i*96) + (75-2)).toString(), opacity: 0, selectable: false, isCounter: true });
        botLines[i] = new fabric.Line([(i*96) + (75-2), 405, (i*96) + (75-2), 725], { id: 'bot'+((i*96) + (75-2)).toString(), opacity: 0, selectable: false, isCounter: true });
