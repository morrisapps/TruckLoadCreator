...
//vertical lines
    ...
    if (truckid == "46 Flatbed"){
        ...
        midLine = new fabric.Line([24*2, 400, 1200-48, 400], {  id: "midLine", stroke: 'black', strokeWidth: 5, height: 7, intersects: true, selectable: false });
    }
    else if (truckid == "Custom Flatbed"){
        vLine2 = new fabric.Line([24*2, 75, 24*2, 725], {  stroke: 'black', strokeWidth: 2, selectable: true, lockMovementY: true, line: true });
        vLine5 = new fabric.Line([600*2, 75, 600*2, 725], {  stroke: 'black', strokeWidth: 2, selectable: true, lockMovementY: true, line: true });
        midLine = new fabric.Line([24*2, 400, 1200, 400], {  id: "midLine", stroke: 'black', strokeWidth: 5, height: 7, intersects: true, selectable: false });
    }
        ...
        midLine = new fabric.Line([24*2, 400, 1200-96, 400], {  id: "midLine", stroke: 'black', strokeWidth: 5, height: 7, intersects: true, selectable: false });
    }
    else {
...
//canvas.add(new fabric.Line([408*2, 425, 408*2, 725], {  stroke: 'black', selectable: false }));
    ...
    //diagonal lines
    /*
    canvas.add(new fabric.Line([0, 75, 24*2+12, 400], {  stroke: 'black', selectable: false }));
    canvas.add(new fabric.Line([24*2+12, 75, 0, 400], {  stroke: 'black', selectable: false }));
