...
function RemoveButton(){
    if (editingUnit != null && editingUnit.unit == true){
        ...
        document.getElementById('location').value = '';
        //document.getElementById('remove').outerHTML = '<button style="margin-top: 20px;" class="buttonRemove" id="remove" name="remove" onclick="RemoveButton()"><span class="buttontiptext">Removed Unit!</span>Removed</button>';
    }else {
